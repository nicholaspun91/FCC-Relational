...
--
-- Name: games fk_o; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT fk_o FOREIGN KEY (opponent_id) REFERENCES public.teams(team_id);


--
-- Name: games fk_w; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT fk_w FOREIGN KEY (winner_id) REFERENCES public.teams(team_id);
